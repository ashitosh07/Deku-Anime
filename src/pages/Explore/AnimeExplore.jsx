...
import animeExploreData from './animeExploreData';
import './AnimeExplore.css';

const AnimeExplore = () => {
  return (
    // <Slider {...settings}>
    <div>
      {animeExploreData.map((movie, index) => (
        <div
          ...
          <div className="grid grid-cols-12 text-white bg-gradient-to-r from-[#121212] via-[#181818]/80 md:via-[#181818]/95  to-transparent min-h-[100vh] px-[1.5rem]">
            <div className="flex flex-col h-full justify-center md:col-span-9 sm:col-span-10 col-span-12 lg:col-span-8 space-y-6 sm:space-y-7 pt-8 sm:pt-0">
              ...
              <p className="sm:hidden flex">
                ...
                that he has not only died, but he has also been reborn as one of
                his beloved machines! Although he is a modern appliance in a
                fantasy world, he requires money in order to keep functioning.
                He is stuck in one location until a young girl named Lammis
                stumbles upon him.
              </p>
              <div className="flex flex-row items-center space-x-6">
                <button className="bg-custom-color transition-all py-3 px-3 sm:px-6 rounded-lg space-x-2 flex items-center justify-center">
                  <svg
                    width="22"
                    height="24"
                    viewBox="0 0 24 24"
